...
window.COLLECTION_CATALOG = {
  version: 2,
  defaultBookId: 'ecuyer-01-player-test',
  series: [
    { id: 'ecuyer-playtest', title: 'L’Écuyer' },
    { id: 'navire-fantome', title: 'Le Navire fantôme' },
    { id: 'sherpa', title: 'Le Sherpa' },
    { id: 'policier-parisien', title: 'Le Policier parisien' }
  ],
  books: [
    { id: 'ecuyer-01-player-test', seriesId: 'ecuyer-playtest', episode: 1, slug: 'la-grotte-de-valombre', title: 'La Grotte de Valombre', access: 'free', status: 'available' },
